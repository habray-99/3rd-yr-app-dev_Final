...
public class UserMetricsController : Controller
{
    ...
    public async Task<IActionResult> Details(int? id)
    {
        ...
        if (userMetric == null) return NotFound();
    ...
    public async Task<IActionResult> Create(
        [Bind("UserMetricID,UserID,TotalBlogPosts,TotalUpvotes,TotalDownvotes,TotalComments")] UserMetric userMetric)
    {
    ...
    public async Task<IActionResult> Edit(int id,
        [Bind("UserMetricID,UserID,TotalBlogPosts,TotalUpvotes,TotalDownvotes,TotalComments")] UserMetric userMetric)
    {
        if (id != userMetric.UserMetricID) return NotFound();
    ...
    {
        var userMetric = await _context.UserMetric.FindAsync(id);
        if (userMetric != null) _context.UserMetric.Remove(userMetric);
