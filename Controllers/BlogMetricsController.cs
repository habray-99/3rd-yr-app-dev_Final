...
public class BlogMetricsController : Controller
{
    ...
    public async Task<IActionResult> Details(int? id)
    {
        ...
        if (blogMetric == null) return NotFound();
    ...
    public async Task<IActionResult> Create(
        [Bind("BlogMetricID,BlogID,TotalUpvotes,TotalDownvotes,TotalComments")] BlogMetric blogMetric)
    {
    ...
    public async Task<IActionResult> Edit(int? id,
        [Bind("BlogMetricID,BlogID,TotalUpvotes,TotalDownvotes,TotalComments")] BlogMetric blogMetric)
    {
        if (id != blogMetric.BlogMetricID) return NotFound();
    ...
    {
        var blogMetric = await _context.BlogMetric.FindAsync(id);
        if (blogMetric != null) _context.BlogMetric.Remove(blogMetric);
